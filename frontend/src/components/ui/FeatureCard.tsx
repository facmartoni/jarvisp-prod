...
function FeatureCard({ 
  ...
  return (
    <div className="relative rounded-xl overflow-hidden transition-all duration-300 hover:shadow-[0_8px_30px_rgba(255,255,255,0.12)] group backdrop-blur-md h-48">
      ...
      <div className="relative grid grid-cols-1 sm:grid-cols-3 gap-0 h-full">
        ...
        {/* Content Section - 2/3 */}
        <div className="sm:col-span-2 p-6 flex flex-col justify-center gap-2 relative z-10">
